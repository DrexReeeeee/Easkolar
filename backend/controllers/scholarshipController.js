...
const { generateSummary, matchScholarshipsAI, getAIEligibilityCheck } = require('../utils/aiHelper');
...
exports.getScholarshipById = async (req, res) => {
  try {
    ...
    const summary = await generateSummary(scholarship.description, scholarship.eligibility);

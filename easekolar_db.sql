...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2025 at 01:33 PM
...
INSERT INTO `users` (`user_id`, `email`, `password`, `course`, `gpa`, `location`, `role`, `preferred_fields`, `createdAt`, `updatedAt`, `full_name`, `birth_date`, `gender`, `address_region`, `address_province`, `address_city`, `contact_number`, `school`, `year_level`, `strand_or_course`, `academic_awards`, `parents_occupation`, `parents_education`, `household_income_range`, `siblings_in_school`, `field_of_interest`, `leadership_experience`, `volunteer_work`, `special_skills`, `special_sector_membership`, `first_name`, `last_name`) VALUES
(1, 'jane.min@example.com', '$2a$10$Ze9xku5huXBSaeJ1hOczcOhanrwKCDx/t6tppcOhlgQo6WdtG8UNW', NULL, NULL, NULL, 'admin', NULL, '2025-10-02 07:04:42', '2025-10-04 18:29:09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jane', 'Manuel'),
(2, 'juan.delacruz@example.com', '$2a$10$G9V6AT0uO2kTABY1xf8Z4.Z78Io2wL8Zwqt.7LQY1wrcAnGu3lUN2', 'BS Information Technology', 93, 'Cebu City', 'student', 'IT, Programming, Data Science', '2025-10-03 09:21:59', '2025-10-04 18:29:51', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Juan', 'Dela Cruz'),
(3, 'maria.santos@example.com', '$2a$10$OQJeNAIMy8H8cCX2gZb78.0J1777u3u/NowRAvJWDQ5cW4DnE0lqu', 'BS Architecture', 91, 'Cebu City', 'student', 'Architecture, Arts', '2025-10-04 07:30:49', '2025-10-04 18:29:37', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Maria', 'Santos'),
(4, 'alice@example.com', '$2a$10$Yig2LUZfB4Ebryjm2u69E.oAthwuTIwb3l5e6xVSzNiq8QiU7ErSm', 'BS Computer Science', 95, 'Cebu City', 'student', 'STEM', '2025-10-04 11:07:46', '2025-10-04 11:10:23', 'Alice Anderson', '2005-08-15', 'Female', 'Region VII', 'Cebu', 'Cebu City', '09123456789', 'ABC High School', 'Grade 12', 'STEM', 'Honor Student', 'Teacher', 'College Graduate', '10k-20k', 2, 'Engineering', 'Class President', 'Cleanup Drives', 'Programming', 'None', 'Alice', 'Anderson');
